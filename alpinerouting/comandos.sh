...
#firewall: su salida a internet se hace a través de la red intrnet
...
#habilitar NAT para lo que salga a través de la red internet
...
docker exec --privileged -it servermysql /bin/sh -c "echo $LINEA_PCADMIN >> /etc/hosts"
